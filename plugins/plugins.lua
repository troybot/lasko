...
local update = 10; --  رقم اصدار السورس 
...
local function run(msg, matches) 
  ...
  for k, v in pairs( plugins_names( )) do  
      -- get the name 
      v = string.match (v, "(.*)%.lua") 
      		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..v..".lua", '◈￤ الملف مقدم من   العراب  \n◈￤ ┇ توصل  مع العراب @ARRAB_H1\n👨🏽‍🔧', dl_cb, nil)
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..file..".lua", '◈￤ الملف مقدم من  العراب  \n◈￤ ┇ توصل  مع العراب @ARRAB_H1\n👨🏽‍🔧', dl_cb, nil)
end
end
end
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, send_file, '◈￤ الملف مقدم من مع  الـزعـيـم  \n◈￤ ┇ توصل  مع العراب @ARRAB_H1\n👨🏽‍🔧', dl_cb, nil)
end
...
return '◈￤ اصدار سورس العراب `V'..update..'` 🍃'
end

if (matches[1] == 'تحديث السورس' or matches[1] == 'update') and is_sudo(msg) then
if tonumber(msg.from.id) ~= tonumber(SUDO)  then return "◈￤ هذا الاوامر للمطور الاساسي فقط " end

tdcli.sendMessage(msg.to.id, msg.id_,1, '◈￤ انتظر قليلا جاري التحديثات ...', 1, 'html')

download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/banhammer.lua','./plugins/banhammer.lua')
download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/groupmanager.lua','./plugins/groupmanager.lua')
download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/msg_checks.lua','./plugins/msg_checks.lua')
download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/plugins.lua','./plugins/plugins.lua')
download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/replay.lua','./plugins/replay.lua')
download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/tools.lua','./plugins/tools.lua')
download_to_file('https://raw.githubusercontent.com/alarrab2/arrab3/master/plugins/zhrf.lua','./plugins/zhrf.lua')
